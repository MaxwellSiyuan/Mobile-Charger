...
HD_PWD='F:/VivadoProject/MobileCharger/MobileCharger.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MobileCharger_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MobileCharger_TOP.tcl
