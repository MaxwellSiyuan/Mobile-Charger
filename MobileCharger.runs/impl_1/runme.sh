...
HD_PWD='F:/VivadoProject/MobileCharger/MobileCharger.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MobileCharger_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MobileCharger_TOP.tcl -notrace
